...
$(document).ready(function () {
    ...
    $.ajax({
        'async': false,
        'global': false,
        'url': '/files/json/view/CrOFGG.json',
...
function displayImages() {
    ...
    for (let i = 0; i < z.length; i++) {
        ...
        if (copyright_institution === photographer) {
            ...
            caption = 'Name: ' + tax + '<br>' + caption + '<br>Copyright Institution:' + copyright_institution + '<br>Photographer:' + photographer + '<br>Indentification Method: ' + indentifcation_method;
        }
        var image = '';
